...
grub_err_t EXPORT_FUNC(grub_derror) (const char *domain,
				     grub_err_t n, const char *fmt, ...);
#define grub_error(n, fmt, args...) grub_derror (0, n, fmt, ##args)
