...
extern struct grub_checkpoint EXPORT_VAR(grub_checkpoints)[128];
extern grub_size_t EXPORT_VAR(grub_checkpoint_cnt);
extern grub_size_t EXPORT_VAR(grub_checkpoint_ptr);

void
EXPORT_FUNC (grub_checkpoint_real) (const char *description, const char *file,
				    int line);

#define grub_checkpoint(x) grub_checkpoint_real (x, GRUB_FILE, __LINE__)
#else
#define grub_checkpoint(x)
#endif
